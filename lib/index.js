...
function makeHtml(documentResult) {
    ...
    try {
        // Это "дефолт"
        //var result = "<div style=\"width:793px; height:1123px; padding: 57pt 42pt 57pt 85pt; margin-bottom: 5pt; background-color: lightblue\">";
    ...
    */
        ...
        var result = "<div style=\"width:" + page.sectPr.pgSz.w + "pt; height: " + page.sectPr.pgSz.h + "pt; " +
                        "padding: " + page.sectPr.pgMar.left +"pt " + page.sectPr.pgMar.top + "pt " + page.sectPr.pgMar.right + "pt " + page.sectPr.pgMar.bottom + "pt; " +
                        "position: relative\">";   // position: relative для того, чтобы можно было использовать дальше абсолютную
        ...
        if(header) {
            ...
            result += "<div style=\"position: absolute; top: " + page.sectPr.pgMar.header + "pt\">" + convertElementsToHtml(header.children) + "</div>";
        }
        ...
        if (footer) {
            ...
            result += "<div style=\"position: absolute; bottom: " + page.sectPr.pgMar.footer + "pt\">" + convertElementsToHtml(footer.children) + "</div>";
        }
