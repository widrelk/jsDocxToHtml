...
function DocumentConversion(options, comments) {
    ...
    function convertToHtml(document) {
        ...
        var html = elementToHtml(document, messages, {});   // Откуда-то есть пустые ol dl?
        ...
        return promises.mapSeries(deferredNodes, function(deferred) {
            ...
            var noDeferred = replaceDeferred(html);     // Всё ещё есть пустые ol dl
                                                        // TODO: Переделать это адекватно
    ...
    function convertRun(run, messages, options) {
        // Странно, разве у run могут быть дети? по крайней мере, не видел такого
        debugger;
        var paths = [];
        if (run.isSmallCaps) {
        ...
        var nodes = function() {    // Какая-то странная функция
