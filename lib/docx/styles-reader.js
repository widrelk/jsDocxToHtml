 ...
 */
// TODO: постараться сделат везде одинаковые названия для свойств
function readStyleElement(styleElement) {
    ...
    if (type == "paragraph"){
        ...
        if (pPr) {
            pPr_spacing = pPr.first("w:spacing");                           // NOTE: По одному маленькому примеру документации, 20 sapcing = 1pt
            if (pPr_spacing) {
                ...
                pPr_spacing = {before: "160pt",                             // Default style values
                                after: "0pt",
                                line: "0pt"}
            }
