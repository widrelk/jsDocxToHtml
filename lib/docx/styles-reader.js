...
// TODO: оформить readParProperties и сделать экспорт. Использовать в body-reader, так как они могут успешно читать любые rPr и pPr
...
function readRunProperties(element) {
    if (element){
        ...
        return {
            ...
            styleId:            sId,
            styleName:          sName,
            isBold:             readBooleanElement(element.children["w:b"]),
            isItalic:           readBooleanElement(element.children["w:i"]),
            isStrikethrough:    readBooleanElement(element.children["w:strike"]),
            ...
            font:               readChildTagAttr(element, "w:rFonts", "w:ascii"),             // TODO: сделать проддержку других семей шрифтов
            ...
            isDStrikethrough:   readBooleanElement(element.children["w:dstrike"]),
            isCaps:             readBooleanElement(element.children["w:caps"]),
            isSmallCaps:        readBooleanElement(element.children["w:smallCaps"])
        };
    } else {
        return {
                type: "runProperties",
