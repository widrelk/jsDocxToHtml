...
function styleName(styleElement) {
    ...
    return nameElement ? nameElement.attributes["w:val"] : false;
}
...
function readParagraphIndent(element) {
    ...
    l = /^[0-9]+$/.test(l) ? parseInt(l, 10) / 2 : 0;
    r = /^[0-9]+$/.test(r) ? parseInt(r, 10) / 2 : 0;
    f = /^[0-9]+$/.test(f) ? parseInt(f, 10) / 2 : 0;
    h = /^[0-9]+$/.test(h) ? parseInt(h, 10) / 2 : 0;
    return {
